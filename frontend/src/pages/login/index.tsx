export default function Login() {
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen bg-neutral-950">
      <div className="flex flex-col items-center justify-center w-1/3 h-2/3 bg-neutral-200 rounded-lg shadow-lg">
        ...
        <form action="" method="post" className="flex flex-col w-100">
          <input
            type="email"
          ...
          <input
            ...
            className="mb-4 p-2 border border-gray-300 rounded bg-neutral-50"
          />
          <button className="bg-neutral-900 text-neutral-50 p-2 rounded hover:bg-neutral-500 transition">
            Login
          </button>
        </form>
